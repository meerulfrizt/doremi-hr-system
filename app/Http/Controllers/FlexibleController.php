    ...
    public function index(Request $request)
    {
        try {
            ...
            foreach ($documents as $doc) {
                ...
                $userResp = Http::get("https://firestore.googleapis.com/v1/projects/{$this->projectId}/databases/(default)/documents/users/{$uid}");
                ...
                $flexList[] = (object) [
                    ...
                    'uid' => $uid,
                    'staff_name' => $f['staffName']['stringValue'] ?? 'Unknown',
                    'date' => $dateStr,
            ...
            if ($action === 'Rejected') {
                ...
                if ($uid) {
                    try {
                        ...
                        $flexiDocResp = Http::get($flexiDocUrl);
