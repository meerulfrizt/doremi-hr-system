    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $row->clock_in  ? \Carbon\Carbon::parse($row->clock_in)->timezone('Asia/Kuala_Lumpur')->format('h:i A')  : '--:--' }}</td>
                <td>{{ $row->clock_out ? \Carbon\Carbon::parse($row->clock_out)->timezone('Asia/Kuala_Lumpur')->format('h:i A') : '--:--' }}</td>
