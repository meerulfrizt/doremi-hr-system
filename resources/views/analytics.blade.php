        ...
        <section class="content">
            ...
            <div class="panel-grid">
                ...
                <div class="dept-list">
                    ...
                    <div class="dept-item"><span>🎙️ Audio Department</span> <span style="font-size:10px; background:#f43f5e; color:white; padding:2px 8px; border-radius:10px;">ACTIVE</span></div>
                    <div class="dept-item"><span>💡 Lighting Department</span> <span style="font-size:10px; background:#f43f5e; color:white; padding:2px 8px; border-radius:10px;">ACTIVE</span></div>
                    <div class="dept-item"><span>📺 Visual Department</span> <span style="font-size:10px; background:#f43f5e; color:white; padding:2px 8px; border-radius:10px;">ACTIVE</span></div>
                    <div class="dept-item"><span>🛠️ Technical Crew</span> <span style="font-size:10px; background:#f43f5e; color:white; padding:2px 8px; border-radius:10px;">ACTIVE</span></div>
                </div>
            </div>
